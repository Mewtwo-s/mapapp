...
function FinishSignUp(props) {
    function handleSubmit(evt){
        ...
        props.changeUserInfo(userId, email, password, firstName,
            lastName, photo)
...
const mapState = state => {
  ...
  const mapDispatch = (dispatch, {history}) => {
    return {
      changeUserInfo: (userId, email, password, firstName,
        lastName, photo) => {
        dispatch(changeUserInfoThunk(userId, email, password, firstName,
            lastName, photo))
      },
     }
  }
