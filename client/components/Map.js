...
const Map = withScriptjs(
  ...
  const getPlaces = async (lat, lng) => {
    try {
      ...
      if(!data){
        data  = await Axios.get(`https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/api/place/textsearch/json?&input=coffee&inputtype=textquery&type=cafe&fields=photos,formatted_address,name,opening_hours,rating&radius=1000&location=${lat},${lng}&key=KEY`).data;
      }
